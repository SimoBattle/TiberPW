...
public class ProductReviews extends HttpServlet {
    ...
    protected void doGet( HttpServletRequest request, HttpServletResponse response ) throws ServletException, IOException {
        ...
        try{
            ...
            getReviews = connection.prepareStatement("SELECT * FROM recensioni WHERE id_birra = ? ORDER BY data ASC");
        ...
        Integer id_birra = Integer.parseInt(request.getParameter("id"));

        try{

            getReviews.setInt(1, id_birra);
            ...
            while (RSreviews.next()){
                String email = RSreviews.getString("email");
